...
public class SoundManager : MonoBehaviour {
	...
	private bool saludo;
	private bool leyo, carta, regalo, agota, debePuerta, acaban, cadaver;
    private bool cadaverPlay;
	...
	void Start () {
        ...
        cadaverPlay = GameObject.FindGameObjectWithTag("Player").GetComponent<PickUp>().getCadaver();
        regalo = false;
		agota = false;
		debePuerta = false;
		tiempoensala = 300;
